		...
		<div class="page" id="register-page">
			...
			<?php if ( 'request-details' == bp_get_current_signup_step() ) : ?>
				...
				<div class="register-section" id="basic-details-section">
					...
					<p style="color:#9E3F2F">Important: </br>You can only register with an firstname.lastname@uni-weimar.de E-Mail address and your username must be the same as it's first part (firstname.lastname)</p>
